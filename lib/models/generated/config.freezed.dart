...
/// Create a copy of Config
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? currentProfileId = freezed,Object? overrideDns = null,Object? hotKeyActions = null,Object? appSettingProps = null,Object? davProps = freezed,Object? networkProps = null,Object? vpnProps = null,Object? themeProps = null,Object? proxiesStyleProps = null,Object? windowProps = null,Object? patchClashConfig = null,Object? excludeSSIDs = null,Object? globalRules = null,Object? legacyGlobalScript = null,}) {
  return _then(_self.copyWith(
...
as List<String>,globalRules: null == globalRules ? _self.globalRules : globalRules // ignore: cast_nullable_to_non_nullable
as List<Rule>,legacyGlobalScript: null == legacyGlobalScript ? _self.legacyGlobalScript : legacyGlobalScript // ignore: cast_nullable_to_non_nullable
as String,
  ));
}
/// Create a copy of Config
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int? currentProfileId,  bool overrideDns,  List<HotKeyAction> hotKeyActions, @JsonKey(fromJson: AppSettingProps.safeFromJson)  AppSettingProps appSettingProps,  DAVProps? davProps,  NetworkProps networkProps,  VpnProps vpnProps, @JsonKey(fromJson: ThemeProps.safeFromJson)  ThemeProps themeProps,  ProxiesStyleProps proxiesStyleProps,  WindowProps windowProps,  PatchClashConfig patchClashConfig,  List<String> excludeSSIDs,  List<Rule> globalRules, @JsonKey(name: 'globalScript', includeToJson: false)  String legacyGlobalScript)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Config() when $default != null:
return $default(_that.currentProfileId,_that.overrideDns,_that.hotKeyActions,_that.appSettingProps,_that.davProps,_that.networkProps,_that.vpnProps,_that.themeProps,_that.proxiesStyleProps,_that.windowProps,_that.patchClashConfig,_that.excludeSSIDs,_that.globalRules,_that.legacyGlobalScript);case _:
  return orElse();
...
@override@JsonKey() List<Rule> get globalRules {
  if (_globalRules is EqualUnmodifiableListView) return _globalRules;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableListView(_globalRules);
}

@override@JsonKey(name: 'globalScript', includeToJson: false) final  String legacyGlobalScript;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Config&&(identical(other.currentProfileId, currentProfileId) || other.currentProfileId == currentProfileId)&&(identical(other.overrideDns, overrideDns) || other.overrideDns == overrideDns)&&const DeepCollectionEquality().equals(other._hotKeyActions, _hotKeyActions)&&(identical(other.appSettingProps, appSettingProps) || other.appSettingProps == appSettingProps)&&(identical(other.davProps, davProps) || other.davProps == davProps)&&(identical(other.networkProps, networkProps) || other.networkProps == networkProps)&&(identical(other.vpnProps, vpnProps) || other.vpnProps == vpnProps)&&(identical(other.themeProps, themeProps) || other.themeProps == themeProps)&&(identical(other.proxiesStyleProps, proxiesStyleProps) || other.proxiesStyleProps == proxiesStyleProps)&&(identical(other.windowProps, windowProps) || other.windowProps == windowProps)&&(identical(other.patchClashConfig, patchClashConfig) || other.patchClashConfig == patchClashConfig)&&const DeepCollectionEquality().equals(other._excludeSSIDs, _excludeSSIDs)&&const DeepCollectionEquality().equals(other._globalRules, _globalRules)&&(identical(other.legacyGlobalScript, legacyGlobalScript) || other.legacyGlobalScript == legacyGlobalScript));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,currentProfileId,overrideDns,const DeepCollectionEquality().hash(_hotKeyActions),appSettingProps,davProps,networkProps,vpnProps,themeProps,proxiesStyleProps,windowProps,patchClashConfig,const DeepCollectionEquality().hash(_excludeSSIDs),const DeepCollectionEquality().hash(_globalRules),legacyGlobalScript);
...
as List<String>,globalRules: null == globalRules ? _self._globalRules : globalRules // ignore: cast_nullable_to_non_nullable
as List<Rule>,legacyGlobalScript: null == legacyGlobalScript ? _self.legacyGlobalScript : legacyGlobalScript // ignore: cast_nullable_to_non_nullable
as String,
  ));
}
