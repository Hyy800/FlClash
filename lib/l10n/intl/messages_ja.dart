...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "addAttachment": MessageLookupByLibrary.simpleMessage("画像またはファイルを追加"),
    ...
    "addUserAgentPreset": MessageLookupByLibrary.simpleMessage(
      "ユーザーエージェントプリセットを追加",
    ),
    ...
    "attachmentTooLarge": MessageLookupByLibrary.simpleMessage("添付ファイルが大きすぎます"),
    ...
    "editAndRetry": MessageLookupByLibrary.simpleMessage("編集して再試行"),
    ...
    "editUserAgentPreset": MessageLookupByLibrary.simpleMessage(
      "ユーザーエージェントプリセットを編集",
    ),
    "emptyTip": m4,
    ...
    "noUserAgentPresets": MessageLookupByLibrary.simpleMessage(
      "カスタムプリセットはまだありません",
    ),
    ...
    "userAgentPresets": MessageLookupByLibrary.simpleMessage("ユーザーエージェントプリセット"),
